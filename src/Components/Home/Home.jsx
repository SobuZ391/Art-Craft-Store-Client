...
import CraftItems from "./craftItemsSection/CraftyItems";
import SubcategoryArtCraft from '../CraftsItemsComponents/SubcategoryArtCraft';
...
`;
    ...
    const handleExpand = () => {
        if (expanded) {
            setDisplayedCraftItems(craftItemsData.slice(0, 6));
        } else {
            setDisplayedCraftItems(craftItemsData);
        }
 ...
 <Reveal keyframes={customAnimation}>  <div className="grid grid-cols-1 lg:grid-cols-3  lg:m-20">
           ...
           <div className='border-y  border-dashed my-2' ></div>
